...
const algorithmCategories = [
  ...
  { name: "Greedy Algorithms", icon: <FaChartLine />, path: "/visualizer", borderColor: "border-yellow-500", bgColor: "bg-yellow-500", image: image4 },
  { name: "Backtracking", icon: <FaPuzzlePiece />, path: "/visualizer", borderColor: "border-gray-500", bgColor: "bg-gray-600", image: image3 },
  { name: "Tree Algorithms", icon: <FaTree />, path: "/visualizer", borderColor: "border-teal-500", bgColor: "bg-teal-500", image: image5 },
];
