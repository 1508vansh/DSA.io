...
const handleStep = () => {
  ...
  const renderStack = (label, stack) => (
    <div className="flex flex-col items-center mx-4">
      ...
      <div className="w-50 h-70 border border-gray-400 rounded p-2 flex flex-col-reverse justify-start items-center gap-2 bg-gray-50">
  ...
  return (
    <div className="mt-4 w-[80%] h-[100%] border-2 gap-1 border-gray-400 rounded-xl mx-auto py-3 px-3 flex flex-col items-center">
    <Link to={'/'} className='text-white font-bold bg-red-500 py-1.5 px-4 rounded-sm'>Back To Algorithms</Link>
    <div className="p-4">
